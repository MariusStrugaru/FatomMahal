...
-- relation 1:m user Product - identity
ALTER TABLE "product" ADD COLUMN "identity" INTEGER REFERENCES "identity"(_id);

-- relation 1:m user Product - User
ALTER TABLE "product" ADD COLUMN "user" INTEGER  REFERENCES "user"(_id);
